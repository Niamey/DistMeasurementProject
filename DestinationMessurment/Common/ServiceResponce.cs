using DestinationMessurment.Service.Core.Common;
using DestinationMessurment.Service.Common.Guard;

namespace DestinationMessurment.Service.Core
{
    public class ServiceResponse
    {
        ...
        public static ServiceResponse BusinessError(string message) => new ServiceResponse(message, errorType: ErrorResponseType.BusinessError);

        public static ServiceResponse<T> BusinessError<T>(string message) => new ServiceResponse<T>(message, errorType: ErrorResponseType.BusinessError);
